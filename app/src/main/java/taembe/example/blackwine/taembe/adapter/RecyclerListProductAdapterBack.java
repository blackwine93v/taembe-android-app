...
public class RecyclerListProductAdapterBack extends RecyclerView.Adapter<RecyclerListProductAdapterBack.ViewHolder> {
    ...
    public RecyclerListProductAdapterBack(Context context, List<Product> products, int type) {
    ...
    private  RecyclerListProductAdapterBack.setOnClickItem listener;
    public  void setOnClickItemEvent(RecyclerListProductAdapterBack.setOnClickItem listener){
        this.listener = listener;
    }

    public  void setOnClickButtonEvent(RecyclerListProductAdapterBack.setOnClickItem listener){
        this.listener = listener;
    }


    @Override
    public RecyclerListProductAdapterBack.ViewHolder  onCreateViewHolder(ViewGroup parent, int viewType) {
